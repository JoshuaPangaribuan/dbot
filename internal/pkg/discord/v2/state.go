...
func (s *StateStore) GetOrSet(key string, factory func() any) any {
	s.mu.Lock()
	defer s.mu.Unlock()
...
func (s *ScopedState) GetOrSet(key string, factory func() any) any {
