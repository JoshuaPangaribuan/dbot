...
type EventPermissionChecker interface {
	HasPermissionForEvent(ctx context.Context, e *v1.Event, permission string) bool
}
...
func (h *HybridPermissionChecker) HasPermissionForEvent(ctx context.Context, e *v1.Event, permission string) bool {
	var userID string
...
func RequireEventPermission(checker EventPermissionChecker, permission string) v1.MiddlewareFunc {
...
func RequireAnyEventPermission(checker EventPermissionChecker, permissions ...string) v1.MiddlewareFunc {
	return func(ctx context.Context, e *v1.Event, next func() error) error {
