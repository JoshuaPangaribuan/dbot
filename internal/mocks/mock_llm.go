...
// Call provides a mock function with given fields: ctx, prompt, opts
func (_m *MockLLM) Call(ctx context.Context, prompt string, opts ...llms.CallOption) (string, error) {
...
func (_e *MockLLM_Expecter) Call(ctx interface{}, prompt interface{}, opts ...interface{}) *MockLLM_Call_Call {
	return &MockLLM_Call_Call{Call: _e.mock.On("Call",
		append([]interface{}{ctx, prompt}, opts...)...)}
}

func (_c *MockLLM_Call_Call) Run(run func(ctx context.Context, prompt string, opts ...llms.CallOption)) *MockLLM_Call_Call {
